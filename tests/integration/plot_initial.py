...
if __name__ == "__main__":
    ...
    rayvis.plot_rays(axis, rayvis.read_rays("data/initial_rays.json"), color="black", alpha=0.9, linewidth=0.1)
    ...
    plt.axis('equal')
    plt.savefig("images/initial_rays.svg", format='svg', dpi=1200)
    plt.clf()
